...
def GeneratePar( iter,
        ...
        while d > eps_dist: # until a suitable parameter is found
           ...
           # if (evaluateprior(proposed_pars,model_TSLT.model) > 0):
#here
...
def GeneratePars( ncpus,
    ...
    if 1 == 0:
        ...
        results = pool.map(func=partial(GeneratePar, previousparlist = previousparlist,
                                        previousweights = previousweights, eps_dist = eps_dist, kernel = kernel),
